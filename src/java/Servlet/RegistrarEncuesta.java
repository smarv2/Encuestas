 ...
 * @author smarv
 */
public class RegistrarEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("NombreEncuesta") != null) {
            NombreEncuesta = request.getParameter("NombreEncuesta");
        }
        ...
        if (con.registraEncuesta(IdEncuesta,NombreEncuesta)) {
            response.sendRedirect("Encuestas.jsp");
        } else {
            response.sendRedirect("AltaEncuestas.jsp?idEncuesta="+IdEncuesta);
        }
    }
